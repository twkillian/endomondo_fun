...
def setup_parser():
    ...
    parser.add_argument('--loss', type=str, default = 'ce', help = 'Loss to use for training model')
    ...
    parser.add_argument('--final_save_fpath', type=str, default = None, help = 'Final filepath in which to save model')
    return parser
